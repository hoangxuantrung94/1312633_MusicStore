app.controller("genreCtrl", function ($scope, $http, $cookies) {
    ...
    $scope.fn_load = function (value) {
        //console.log(value);
        return $scope.songsGenre = $http.get('https://music-store-app-1312.herokuapp.com/api/v1/song/genre/' + value)
    ...
    $scope.getSongGenre = function (value) {
        //console.log(value);
        return $scope.songsGenres = $http.get('https://music-store-app-1312.herokuapp.com/api/v1/song/genre/' + value)
            .then(function (response) {
    ...
    $http.get('https://music-store-app-1312.herokuapp.com/api/v1/genre')
        .then(function (response) {
            $scope.genres = response.data;
        });

    $http.get('https://music-store-app-1312.herokuapp.com/api/v1/song')
        .then(function (response) {
